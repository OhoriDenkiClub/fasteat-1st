    ...
    <div id="nav_content">
        <div id="order_view" class="view">
            ...
            <div class="prods border-radius-1" id="prod1">
                ...
                <div class="width-fit-content">クロワッサン　キャラメル</div>
            ...
            <div class="prods border-radius-1" id="prod2">
                <div class="spacer"></div>
                <div class="width-fit-content">クロワッサン　チョコ</div>
            ...
            <div class="prods border-radius-1" id="prod3">
                <div class="spacer"></div>
                <div class="width-fit-content">クロワッサン　イチゴ</div>
            ...
            <br>
            <div class="prods border-radius-1" id="prod4">
                <div class="spacer"></div>
                <div class="width-fit-content">タルト</div>
                <div id="prod-num-output4">0</div>
                <div class="prod-num-input border-radius-1">
                    <button type="button" id="order-button-4-minus" class="prod-num-btn border-radius-1" onclick="prod_button_onclick('4', 'minus')">-</button>
                    <div class="order-prods-partition width-fit-content">|</div>
                    <button type="button" id="order-button-4-plus" class="prod-num-btn border-radius-1" onclick="prod_button_onclick('4', 'plus')">+</button>
                </div>
                <div class="spacer"></div>
            </div>
            <br>
        ...
        <div id="reception_view" class="view">
            ...
            <div id="reception-table-head">
                ...
                <div id="reception-table-head-prod1" class="text-align-center height-fit-content">キャラメル</div>
                <div id="reception-table-head-prod2" class="text-align-center height-fit-content">チョコ</div>
                <div id="reception-table-head-prod3" class="text-align-center height-fit-content">イチゴ</div>
                <div id="reception-table-head-prod4" class="text-align-center height-fit-content">タルト</div>
