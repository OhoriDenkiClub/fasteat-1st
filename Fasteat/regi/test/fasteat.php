...
<body>
    ...
    <div id="nav_bar">
        <h1 id="nav_title"><!--クラスを入力-->test</h1>
        <div id="nav_button">
    ...
    <div id="nav_content">
        <div id="order_view" class="view">
            ...
            <div class="prods border-radius-1" id="prod1">
                ...
                <div class="width-fit-content">商品A</div>
            ...
            <div class="prods border-radius-1" id="prod2">
                <div class="spacer"></div>
                <div class="width-fit-content">商品B</div>
        ...
        <div id="reception_view" class="view">
            ...
            <div id="reception-table-head">
                ...
                <div id="reception-table-head-prod1" class="text-align-center height-fit-content">商品A</div>
                <div id="reception-table-head-prod2" class="text-align-center height-fit-content">商品B</div>
