    ...
    <div id="nav_content">
        <div id="order_view" class="view">
            ...
            <div class="prods border-radius-1" id="prod1">
                ...
                <div class="width-fit-content">たこ焼き</div>
            ...
            <div class="prods border-radius-1" id="prod2">
                <div class="spacer"></div>
                <div class="width-fit-content">明太マヨたこ焼き</div>
            ...
            <div class="prods border-radius-1" id="prod3">
                <div class="spacer"></div>
                <div class="width-fit-content">チーズinたこ焼き</div>
        ...
        <div id="reception_view" class="view">
            ...
            <div id="reception-table-head">
                ...
                <div id="reception-table-head-prod1" class="text-align-center height-fit-content">たこ焼き</div>
                <div id="reception-table-head-prod2" class="text-align-center height-fit-content">明太マヨたこ焼き</div>
                <div id="reception-table-head-prod3" class="text-align-center height-fit-content">チーズinたこ焼き</div>
