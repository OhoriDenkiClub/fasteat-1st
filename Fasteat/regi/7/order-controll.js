...
window.addEventListener( "load" , ()=> {
    ...
    document.getElementById("order-button-3-minus").setAttribute("disabled", true);
    document.getElementById("order-button-4-minus").setAttribute("disabled", true);
...
function prod_button_onclick(num, type){
    ...
    var prod3=document.getElementById("prod-num-output3");
    var prod4=document.getElementById("prod-num-output4");
    // 商品数に合わせて加減
    var prod1_num=Number(prod1.innerHTML);
    var prod2_num=Number(prod2.innerHTML);
    var prod3_num=Number(prod3.innerHTML);
    var prod4_num=Number(prod4.innerHTML);
    ...
    if (num == "1"){
        if (type=="minus"){
            ...
            if(prod1_num==0){
                document.getElementById("order-button-1-minus").setAttribute("disabled", true);
                if(prod2_num==0 && prod3_num==0 && prod4_num==0){
        ...
        if (type=="minus"){
            ...
            if(prod2_num==0){
                document.getElementById("order-button-2-minus").setAttribute("disabled", true);
                if(prod1_num==0 && prod3_num==0 && prod4_num==0){
                    send_button.setAttribute("disabled", true);
                    document.getElementById("order-send-button").classList.add("order-send-button-after");
                } else{
                    send_button.removeAttribute("disabled");
        ...
        if (type=="minus"){
            prod3_num=prod3_num-1;
            prod3.innerHTML=prod3_num;
            if(prod3_num==0){
                document.getElementById("order-button-3-minus").setAttribute("disabled", true);
                if(prod1_num==0 && prod2_num==0 && prod4_num==0){
                    send_button.setAttribute("disabled", true);
                    document.getElementById("order-send-button").classList.add("order-send-button-after");
                } else{
                    send_button.removeAttribute("disabled");
            ...
            prod3_num=prod3_num+1;
            prod3.innerHTML=prod3_num;
            document.getElementById("order-button-3-minus").removeAttribute("disabled");
            send_button.removeAttribute("disabled");
            document.getElementById("order-send-button").classList.remove("order-send-button-after");
        }
    } else if(num=="4"){
        if (type=="minus"){
            prod4_num=prod4_num-1;
            prod4.innerHTML=prod4_num;
            if(prod4_num==0){
                document.getElementById("order-button-4-minus").setAttribute("disabled", true);
                if(prod1_num==0 && prod3_num==0 && prod2_num==0){
                    send_button.setAttribute("disabled", true);
                    document.getElementById("order-send-button").classList.add("order-send-button-after");
                } else{
                    send_button.removeAttribute("disabled");
            ...
            prod4_num=prod4_num+1;
            prod4.innerHTML=prod4_num;
            document.getElementById("order-button-4-minus").removeAttribute("disabled");
            send_button.removeAttribute("disabled");
            document.getElementById("order-send-button").classList.remove("order-send-button-after");
        }
    }
    ...
    .then(()=>{
        non_docRef.set({
            ...
            .then(() => {
                ...
                document.getElementById("prod-num-output3").innerHTML=0;
                document.getElementById("prod-num-output4").innerHTML=0;
                document.getElementById("order-button-1-minus").setAttribute("disabled", true);
                document.getElementById("order-button-2-minus").setAttribute("disabled", true);
                document.getElementById("order-button-3-minus").setAttribute("disabled", true);
                document.getElementById("order-button-4-minus").setAttribute("disabled", true);
